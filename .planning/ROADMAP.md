...
- [ ] 02-03-PLAN.md — Scroll infinito: servidor simulado com cursor (~40/cidade), carregarMais guardado, rodapés loading/erro/fim (VIT-05)
...
| 2. Vitrine — Lista, Busca e Ordenação | 2/5 | In Progress|  |
