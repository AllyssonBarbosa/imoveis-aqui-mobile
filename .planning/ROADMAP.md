...
- [ ] 02-02-PLAN.md — `GET /api/publico/cidades/` no repo irmão (feat/APP02, sem commit sem aval) + seed de dev + adendos ao contrato (API-02)
...
| 2. Vitrine — Lista, Busca e Ordenação | 1/5 | In Progress|  |
